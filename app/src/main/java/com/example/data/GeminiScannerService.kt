...
object GeminiScannerService {
     ...
     */
    suspend fun scanReceipt(bitmap: Bitmap?, sampleType: String? = null): ExtractedReceipt = withContext(Dispatchers.IO) {
        val apiKey = BuildConfig.GEMINI_API_KEY
        val isDefaultKey = apiKey == "MY_GEMINI_API_KEY" || apiKey.isBlank()
        
        Log.i(TAG, "Scanning receipt... sampleType=$sampleType, keyIsPlaceholder=$isDefaultKey")
